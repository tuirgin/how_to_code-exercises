...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname htdd-design_quiz-02-code_review_by_sasmita) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;; HtDD Design Quiz
...
;; SCORE:3 Points
;;
;; COMMENTS: Following comments are for 4th section as well:
;;    Problem 1:
;;	a) Template is missing
;;	b) Stub is present but 'Stub' word is not written in front of it. (Check Line 32)
;;
;;    Problem 2:
;;	a) Examples are not written for the data definition.
;;
;;    Problem 3:
;;	a) Purpose can be more i.e what is MonthAge?.. Can be written as Age in months.
;;	b) Template is not written
;;
;;    Problem 4:
;;	a) <template from Health> -> This comments is missing
;;
;;==============================================================================
;;
...
;; SCORE: 2 Points
;;
;; COMMENTS: Please check comments from 3rd section
;;
;;==============================================================================
;;
...
;;------------------------------------------------------------------------------
;;
;; COMMENTS: Problem Statment are satisfied, but the coding standard is not maintained as specified in Design Recipe.
;;           
